...
export default function ProjectsCarouselClient({projects}: {projects: Project[]}) {
      ...
      <div className="mx-auto w-full max-w-[1720px] px-6 py-16 sm:px-10 lg:px-14 lg:py-20">
        <div className="grid grid-cols-1 items-start gap-10 xl:grid-cols-12">
          ...
          <div className="xl:col-span-9">
            {/* Mobile vertical scroll (3 cards per screen, no arrows, scrollbar hidden) */}
          ...
          {/* ===== Desktop/Tablet Aside (Our Projects, arrows, View All) ===== */}
